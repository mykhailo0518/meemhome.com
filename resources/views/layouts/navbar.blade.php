            ...
            <div class=" d-none d-md-block">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                    ...
                    <li class="nav-item ps-3">
                        <a class="nav-link cursor-pointer px-0" data-bs-toggle="modal" data-bs-target="#searchModal">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" style="width:1.5rem;height:1.5rem;">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
                            </svg>
                        </a>
                    ...
                    @endguest
                    <li class="nav-item ps-3">
                        <a class="nav-link px-0 @if (Route::currentRouteName() == 'cart') active @endif"
                            href="{{ route('cart') }}">
                            <div class="position-relative">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" style="width:1.5rem;height:1.5rem;">
